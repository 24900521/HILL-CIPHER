...
int main() {
  char msg[] = "VIGNESH", enc[100], dec[100];
...
## OUTPUT
<img width="1920" height="1200" alt="image" src="https://github.com/user-attachments/assets/06f12331-c9a1-4007-9113-357356425fe6" />


## RESULT
The given program is verified and executed successfully
